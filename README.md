...
You can see an example evaluation workflow shown below with a new branch using the llmeter python package to perform benchmarking of the LLM for latency and throughput.
