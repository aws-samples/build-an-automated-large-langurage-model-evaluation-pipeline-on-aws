...
class KnowledgeBasesEvaluations:    
    ...
    def evaluate(self, dataset_dict=None):
...
class KnowledgeBasesGenerateAnswer:
    def __init__(self, model_id: str, question: str, KB_ID: str):
    ...
    def prepare_evaluation_dataset(self):
        ...
        answer = self.qa_chain.invoke(self.question)["result"]

        self.contexts.append([docs.page_content for docs in self.retriever.invoke(self.question)])
        # To dict
        data = {
